    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400">
          Buat artikel menggunakan editor interaktif TipTap.
        </p>
      </div>
            ...
            <Card>
              <CardContent className="pt-6 space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="title" name="title" required placeholder="Masukkan judul..." className="text-lg font-semibold" />
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="excerpt" name="excerpt" placeholder="Deskripsi singkat..." />
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="tags">Tag (Pisahkan dengan koma)</Label>
                  <Input id="tags" name="tags" placeholder="Tech, Next.js, Tips" />
                </div>
                
                <div className="flex items-center gap-2 pt-2">
                  <input type="checkbox" id="published" name="published" className="rounded border-zinc-300" />
